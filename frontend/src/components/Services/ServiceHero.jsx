...
// import { Settings, Code, Cpu, BarChart3 } from 'lucide-react';

// const ServiceHero = () => {
//   return (
//     <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-white pt-28 pb-10">
      
//       {/* 🟢 Background Animated Blobs */}
//       <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-blue-50 rounded-full filter blur-[120px] animate-soft-pulse opacity-70"></div>
//       <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-indigo-50 rounded-full filter blur-[120px] animate-soft-pulse opacity-70"></div>
...
//             Our <span className="text-indigo-600 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Digital</span> <br />
//             Expertise.
//           </h1>
//           <p className="mt-6 text-lg text-slate-500 font-medium max-w-md mx-auto lg:mx-0">
//             Apan advanced software ani design solutions provide karto jyamule tumchi business growth fast hote.
//           </p>
//         </motion.div>

//         {/* Right Side: 3D Visual with Fixed Overlay */}
//         <div className="relative flex justify-center items-center h-full">
          
//           {/* Main 3D Illustration (Z-index kami kela) */}
//           <motion.div 
//             animate={{ y: [0, -15, 0] }}
...
//           >
//             <img 
//               src="https://media.istockphoto.com/id/1096969570/vector/isometric-illustration-with-a-laptop-men-and-women-working-on-web-design.jpg?s=612x612&w=0&k=20&c=a3VvtOOYjuI0Sux_WmMEg_WHp6Bkgxh3HfY7BK6LIzA=" 
//               alt="Service 3D"
//               className="w-80 lg:w-[450px] rounded-[2rem] drop-shadow-2xl opacity-90"
//             />
//           </motion.div>

//           {/* 🧊 Floating Cards (Z-index high kela jene karun image chya VAR distil) */}
//           <motion.div 
//             animate={{ y: [0, 25, 0], x: [0, 15, 0] }}
//             transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
//             className="absolute top-0 right-0 md:right-5 bg-white/80 backdrop-blur-md p-5 rounded-[1.5rem] shadow-2xl border border-white/50 flex items-center gap-4 z-20"
//           >
//             <div className="bg-blue-600 p-3 rounded-xl text-white shadow-lg shadow-blue-200"><Code size={24}/></div>
//             <div>
//               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Development</p>
//               <p className="font-black text-slate-800">Clean Code</p>
//             </div>
//           </motion.div>
...
//             className="absolute bottom-5 left-0 md:left-5 bg-white/80 backdrop-blur-md p-5 rounded-[1.5rem] shadow-2xl border border-white/50 flex items-center gap-4 z-20"
//           >
//             <div className="bg-indigo-600 p-3 rounded-xl text-white shadow-lg shadow-indigo-200"><Settings size={24}/></div>
//             <div>
//               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Automation</p>
//               <p className="font-black text-slate-800">Fast Workflow</p>
//             </div>
//           </motion.div>
//         </div>
